				...
				<div class="col-md-8 col-md-offset-2 text-center">
					<div class="display-t">
						<div class="display-tc">
							<h1 class="animate-box" data-animate-effect="fadeInUp">Overseas Jobs</h1>
...
$sql = "SELECT * FROM postjob where Country not like '%india%' order by id desc limit $start_from,$num_rec_per_page";
...
?>
	...
	<div>
	<?php
	$sql1= "select *from postjob where Country not like '%india%' ";
	...
	echo " <li><a href='overseas1.php?page=1' >|<</a></li> ";
	$class="";
	for($j=1;$j<=$total_pages;$j++)
	{
		if(isset($_GET['page']))
		{
		 ...
		 echo "<li class=$class><a href='overseas1.php?page=$j' >$j</a></li> "; 
	}
	
	echo "<li><a href='overseas1.php?page=$total_pages'>>|</a></li>";
	echo"</ul>";
